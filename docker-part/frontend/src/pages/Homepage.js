...
const Home = () => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
    <div className="bg-blue-100 border-l-4 border-blue-500 p-4 rounded shadow">
      <h4 className="text-sm font-medium text-blue-700">Assigned Tasks</h4>
      <p className="text-2xl font-bold text-blue-900">{summary.assigned_tasks}</p>
    </div>
    ...
    <div className="bg-purple-100 border-l-4 border-purple-500 p-4 rounded shadow">
      <h4 className="text-sm font-medium text-purple-700">Completion Rate</h4>
      <p className="text-2xl font-bold text-purple-900">{summary.completion_rate}%</p>
    </div>
  </div>
)} */}
